    ...
    <div className="bg-white rounded-2xl p-8 w-full">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2.5 rounded-full transition-colors disabled:opacity-60"
        >
