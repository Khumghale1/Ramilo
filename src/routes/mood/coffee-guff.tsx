...
import { Coffee, ArrowLeft, MapPin, Tag } from 'lucide-react'
...
const places = [
  ...
  { id: 2, name: 'Roadhouse Cafe', location: 'Thamel', priceRange: 'Budget', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&q=80' },
  { id: 3, name: 'OR2K', location: 'Thamel', priceRange: 'Mid-range', image: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=600&q=80' },
]
      ...
      <div className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="flex items-center gap-4 mb-2">
          <div className="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center">
            <Coffee size={22} className="text-[#CA4141]" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Coffee & Guff</h1>
            <p className="text-gray-500 text-sm">Casual hangouts with friends</p>
          </div>
        </div>
