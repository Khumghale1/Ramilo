...
import { Wallet, ArrowLeft, MapPin, Heart, Loader2, Check, BookmarkPlus } from 'lucide-react'
...
const places = [
  {
    ...
    description: 'A cozy tea house offering traditional Nepali tea and snacks at affordable prices, perfect for a relaxed afternoon with friends.',
    tags: ['Outdoor Seating', 'Local Food', 'Budget Friendly'],
  },
  {
    id: 2,
    ...
    description: 'Famous local spot serving the best street momos in town. A must-visit for authentic Nepali street food experience.',
    tags: ['Street Food', 'Quick Bites', 'Local Favorite'],
  },
  {
    id: 3,
    name: 'Namaste Cafe',
    ...
    description: 'A peaceful cafe near the stupa offering affordable meals and drinks with a view of the Buddhist monument.',
    tags: ['WiFi', 'Scenic View', 'Vegetarian Options'],
  },
]
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div className="flex items-center gap-3 md:gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-red-50 rounded-xl flex items-center justify-center">
              <Wallet size={20} className="md:hidden text-[#CA4141]" />
              <Wallet size={22} className="hidden md:block text-[#CA4141]" />
            </div>
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Budget Hangout</h1>
              <p className="text-gray-500 text-xs md:text-sm">Affordable fun</p>
            </div>
          </div>
