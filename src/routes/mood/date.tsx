...
import { Heart, ArrowLeft, MapPin, Wallet, Loader2, Check, BookmarkPlus } from 'lucide-react'
...
const places = [
  {
    ...
    description: 'An exquisite heritage hotel offering romantic dining experiences with traditional Nepali architecture and world-class cuisine.',
    tags: ['Fine Dining', 'Heritage', 'Romantic Ambience'],
  },
  {
    id: 2,
    name: 'The Garden of Dreams',
    location: 'Kaisermahal',
    priceRange: 'Mid-range',
    image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=80',
    description: 'A beautifully restored neo-classical garden perfect for romantic strolls and intimate conversations.',
    tags: ['Garden', 'Peaceful', 'Photo Spots'],
  },
  {
    id: 3,
    name: 'Bhojan Griha',
    ...
    description: 'Traditional Nepali restaurant in a restored heritage building, offering cultural performances and authentic cuisine.',
    tags: ['Cultural Experience', 'Traditional Food', 'Live Music'],
  },
]
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div className="flex items-center gap-3 md:gap-4">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-red-50 rounded-xl flex items-center justify-center">
              <Heart size={20} className="md:hidden text-[#CA4141]" />
              <Heart size={22} className="hidden md:block text-[#CA4141]" />
            </div>
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Date</h1>
              <p className="text-gray-500 text-xs md:text-sm">Perfect for romantic moments</p>
            </div>
          </div>
