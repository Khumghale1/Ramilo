...
export default function BusinessLayout({ children }: BusinessLayoutProps) {
  ...
  const isActive = (href: string) => {
    if (href === "/business") {
      return location.pathname === "/business" || location.pathname.startsWith("/business/edit")
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900">Business Portal</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
      ...
      <div className="lg:pl-64">
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-white border-b border-gray-200 px-4 h-14 flex items-center">
          ...
          <span className="ml-3 font-semibold text-gray-900">Business Portal</span>
        </header>

        {/* Desktop header */}
        <DashboardHeader title="Business Portal" variant="business" />
